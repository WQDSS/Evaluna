...
docker build --rm -f "Dockerfile" -t waterqualitydss-test:latest -t "booooh/waterqualitydss-test:$image_tag" --target test .
docker push "booooh/waterqualitydss:$image_tag"
docker push "booooh/waterqualitydss-test:$image_tag"
